...
func (_m *TemplateRepository) Delete(ctx context.Context, templateURN string) error {
...
func (_m *TemplateRepository) Read(ctx context.Context, templateURN string) ([]tag.Template, error) {
	ret := _m.Called(ctx, templateURN)
...
func (_m *TemplateRepository) ReadAll(ctx context.Context) ([]tag.Template, error) {
	ret := _m.Called(ctx)

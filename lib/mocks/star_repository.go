...
//  - cfg star.Config
//  - userEmail string
func (_e *StarRepository_Expecter) GetAllAssetsByUserEmail(ctx interface{}, cfg interface{}, userEmail interface{}) *StarRepository_GetAllAssetsByUserEmail_Call {
	return &StarRepository_GetAllAssetsByUserEmail_Call{Call: _e.mock.On("GetAllAssetsByUserEmail", ctx, cfg, userEmail)}
}

func (_c *StarRepository_GetAllAssetsByUserEmail_Call) Run(run func(ctx context.Context, cfg star.Config, userEmail string)) *StarRepository_GetAllAssetsByUserEmail_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(star.Config), args[2].(string))
	})
	return _c
}
...
//  - cfg star.Config
//  - userID string
func (_e *StarRepository_Expecter) GetAllAssetsByUserID(ctx interface{}, cfg interface{}, userID interface{}) *StarRepository_GetAllAssetsByUserID_Call {
	return &StarRepository_GetAllAssetsByUserID_Call{Call: _e.mock.On("GetAllAssetsByUserID", ctx, cfg, userID)}
}

func (_c *StarRepository_GetAllAssetsByUserID_Call) Run(run func(ctx context.Context, cfg star.Config, userID string)) *StarRepository_GetAllAssetsByUserID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(star.Config), args[2].(string))
	})
	return _c
...
//  - cfg star.Config
//  - assetID string
func (_e *StarRepository_Expecter) GetStargazers(ctx interface{}, cfg interface{}, assetID interface{}) *StarRepository_GetStargazers_Call {
	return &StarRepository_GetStargazers_Call{Call: _e.mock.On("GetStargazers", ctx, cfg, assetID)}
}

func (_c *StarRepository_GetStargazers_Call) Run(run func(ctx context.Context, cfg star.Config, assetID string)) *StarRepository_GetStargazers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(star.Config), args[2].(string))
	})
	return _c

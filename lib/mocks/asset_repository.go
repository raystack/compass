...
func (_c *AssetRepository_GetAll_Call) Run(run func(_a0 context.Context, _a1 asset.Config)) *AssetRepository_GetAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(asset.Config))
	})
	return _c
}
...
func (_c *AssetRepository_GetCount_Call) Run(run func(_a0 context.Context, _a1 asset.Config)) *AssetRepository_GetCount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(asset.Config))
	})
	return _c
...
//  - cfg asset.Config
//  - id string
func (_e *AssetRepository_Expecter) GetVersionHistory(ctx interface{}, cfg interface{}, id interface{}) *AssetRepository_GetVersionHistory_Call {
	return &AssetRepository_GetVersionHistory_Call{Call: _e.mock.On("GetVersionHistory", ctx, cfg, id)}
}

func (_c *AssetRepository_GetVersionHistory_Call) Run(run func(ctx context.Context, cfg asset.Config, id string)) *AssetRepository_GetVersionHistory_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(asset.Config), args[2].(string))
	})
	return _c
}

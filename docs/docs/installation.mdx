...
- See the [Configurations](./configuration) page on how to setup Compass server and client
- See the [CLI Reference](./reference/cli) for a complete list of commands and options.

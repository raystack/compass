...
// CreateComment provides a mock function with given fields: ctx, ns, cmt
func (_m *DiscussionService) CreateComment(ctx context.Context, ns *namespace.Namespace, cmt *discussion.Comment) (string, error) {
	ret := _m.Called(ctx, ns, cmt)

	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *namespace.Namespace, *discussion.Comment) (string, error)); ok {
		return rf(ctx, ns, cmt)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *namespace.Namespace, *discussion.Comment) string); ok {
		r0 = rf(ctx, ns, cmt)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *namespace.Namespace, *discussion.Comment) error); ok {
		r1 = rf(ctx, ns, cmt)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *DiscussionService_Expecter) CreateComment(ctx interface{}, ns interface{}, cmt interface{}) *DiscussionService_CreateComment_Call {
	return &DiscussionService_CreateComment_Call{Call: _e.mock.On("CreateComment", ctx, ns, cmt)}
}

func (_c *DiscussionService_CreateComment_Call) Run(run func(ctx context.Context, ns *namespace.Namespace, cmt *discussion.Comment)) *DiscussionService_CreateComment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*namespace.Namespace), args[2].(*discussion.Comment))
	})
	return _c
}
...
func (_c *DiscussionService_CreateComment_Call) RunAndReturn(run func(context.Context, *namespace.Namespace, *discussion.Comment) (string, error)) *DiscussionService_CreateComment_Call {
	_c.Call.Return(run)
	return _c
}

// CreateDiscussion provides a mock function with given fields: ctx, ns, _a2
func (_m *DiscussionService) CreateDiscussion(ctx context.Context, ns *namespace.Namespace, _a2 *discussion.Discussion) (string, error) {
	ret := _m.Called(ctx, ns, _a2)

	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *namespace.Namespace, *discussion.Discussion) (string, error)); ok {
		return rf(ctx, ns, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *namespace.Namespace, *discussion.Discussion) string); ok {
		r0 = rf(ctx, ns, _a2)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *namespace.Namespace, *discussion.Discussion) error); ok {
		r1 = rf(ctx, ns, _a2)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - ns *namespace.Namespace
//   - _a2 *discussion.Discussion
func (_e *DiscussionService_Expecter) CreateDiscussion(ctx interface{}, ns interface{}, _a2 interface{}) *DiscussionService_CreateDiscussion_Call {
	return &DiscussionService_CreateDiscussion_Call{Call: _e.mock.On("CreateDiscussion", ctx, ns, _a2)}
}

func (_c *DiscussionService_CreateDiscussion_Call) Run(run func(ctx context.Context, ns *namespace.Namespace, _a2 *discussion.Discussion)) *DiscussionService_CreateDiscussion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*namespace.Namespace), args[2].(*discussion.Discussion))
	})
	return _c
}
...
func (_c *DiscussionService_CreateDiscussion_Call) RunAndReturn(run func(context.Context, *namespace.Namespace, *discussion.Discussion) (string, error)) *DiscussionService_CreateDiscussion_Call {
	_c.Call.Return(run)
	return _c
}
...
type mockConstructorTestingTNewDiscussionService interface {
	mock.TestingT
	Cleanup(func())
}

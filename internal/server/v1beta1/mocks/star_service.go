...
// NewStarService creates a new instance of StarService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewStarService(t testing.TB) *StarService {
	mock := &StarService{}
	mock.Mock.Test(t)

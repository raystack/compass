...
// DeleteAsset provides a mock function with given fields: ctx, ns, id
func (_m *AssetService) DeleteAsset(ctx context.Context, ns *namespace.Namespace, id string) error {
...
//   - ns *namespace.Namespace
//   - id string
func (_e *AssetService_Expecter) DeleteAsset(ctx interface{}, ns interface{}, id interface{}) *AssetService_DeleteAsset_Call {
	return &AssetService_DeleteAsset_Call{Call: _e.mock.On("DeleteAsset", ctx, ns, id)}
}

func (_c *AssetService_DeleteAsset_Call) Run(run func(ctx context.Context, ns *namespace.Namespace, id string)) *AssetService_DeleteAsset_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AssetService_DeleteAsset_Call) RunAndReturn(run func(context.Context, *namespace.Namespace, string) error) *AssetService_DeleteAsset_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpsertAsset provides a mock function with given fields: ctx, ns, ast, upstreams, downstreams
func (_m *AssetService) UpsertAsset(ctx context.Context, ns *namespace.Namespace, ast *asset.Asset, upstreams []string, downstreams []string) (string, error) {
	ret := _m.Called(ctx, ns, ast, upstreams, downstreams)

	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *namespace.Namespace, *asset.Asset, []string, []string) (string, error)); ok {
		return rf(ctx, ns, ast, upstreams, downstreams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *namespace.Namespace, *asset.Asset, []string, []string) string); ok {
		r0 = rf(ctx, ns, ast, upstreams, downstreams)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *namespace.Namespace, *asset.Asset, []string, []string) error); ok {
		r1 = rf(ctx, ns, ast, upstreams, downstreams)
	} else {
		r1 = ret.Error(1)
	}
...
//   - upstreams []string
//   - downstreams []string
func (_e *AssetService_Expecter) UpsertAsset(ctx interface{}, ns interface{}, ast interface{}, upstreams interface{}, downstreams interface{}) *AssetService_UpsertAsset_Call {
	return &AssetService_UpsertAsset_Call{Call: _e.mock.On("UpsertAsset", ctx, ns, ast, upstreams, downstreams)}
}

func (_c *AssetService_UpsertAsset_Call) Run(run func(ctx context.Context, ns *namespace.Namespace, ast *asset.Asset, upstreams []string, downstreams []string)) *AssetService_UpsertAsset_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*namespace.Namespace), args[2].(*asset.Asset), args[3].([]string), args[4].([]string))
	})
	return _c
}
...
func (_c *AssetService_UpsertAsset_Call) RunAndReturn(run func(context.Context, *namespace.Namespace, *asset.Asset, []string, []string) (string, error)) *AssetService_UpsertAsset_Call {
	_c.Call.Return(run)
	return _c
}

// UpsertAssetWithoutLineage provides a mock function with given fields: ctx, ns, ast
func (_m *AssetService) UpsertAssetWithoutLineage(ctx context.Context, ns *namespace.Namespace, ast *asset.Asset) (string, error) {
...
//   - ns *namespace.Namespace
//   - ast *asset.Asset
func (_e *AssetService_Expecter) UpsertAssetWithoutLineage(ctx interface{}, ns interface{}, ast interface{}) *AssetService_UpsertAssetWithoutLineage_Call {
	return &AssetService_UpsertAssetWithoutLineage_Call{Call: _e.mock.On("UpsertAssetWithoutLineage", ctx, ns, ast)}
}

func (_c *AssetService_UpsertAssetWithoutLineage_Call) Run(run func(ctx context.Context, ns *namespace.Namespace, ast *asset.Asset)) *AssetService_UpsertAssetWithoutLineage_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AssetService_UpsertAssetWithoutLineage_Call) RunAndReturn(run func(context.Context, *namespace.Namespace, *asset.Asset) (string, error)) *AssetService_UpsertAssetWithoutLineage_Call {
	_c.Call.Return(run)
	return _c
}

...
// GetTypes provides a mock function with given fields: ctx
func (_m *AssetService) GetTypes(ctx context.Context) (map[asset.Type]int, error) {
	ret := _m.Called(ctx)
...
//  - ctx context.Context
func (_e *AssetService_Expecter) GetTypes(ctx interface{}) *AssetService_GetTypes_Call {
	return &AssetService_GetTypes_Call{Call: _e.mock.On("GetTypes", ctx)}
}

func (_c *AssetService_GetTypes_Call) Run(run func(ctx context.Context)) *AssetService_GetTypes_Call {
	_c.Call.Run(func(args mock.Arguments) {

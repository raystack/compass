...
func (_m *NamespaceService) Create(ctx context.Context, ns *namespace.Namespace) (string, error) {
...
func (_c *NamespaceService_Create_Call) Return(_a0 string, _a1 error) *NamespaceService_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *NamespaceService_Create_Call) RunAndReturn(run func(context.Context, *namespace.Namespace) (string, error)) *NamespaceService_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *NamespaceService) Update(ctx context.Context, ns *namespace.Namespace) error {
	ret := _m.Called(ctx, ns)

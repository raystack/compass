...
func (_m *DiscussionRepository) Create(ctx context.Context, ns *namespace.Namespace, _a2 *discussion.Discussion) (string, error) {
...
func (_e *DiscussionRepository_Expecter) Create(ctx interface{}, ns interface{}, _a2 interface{}) *DiscussionRepository_Create_Call {
	return &DiscussionRepository_Create_Call{Call: _e.mock.On("Create", ctx, ns, _a2)}
}

func (_c *DiscussionRepository_Create_Call) Run(run func(ctx context.Context, ns *namespace.Namespace, _a2 *discussion.Discussion)) *DiscussionRepository_Create_Call {
...
func (_c *DiscussionRepository_Create_Call) RunAndReturn(run func(context.Context, *namespace.Namespace, *discussion.Discussion) (string, error)) *DiscussionRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}

// CreateComment provides a mock function with given fields: ctx, ns, cmt
func (_m *DiscussionRepository) CreateComment(ctx context.Context, ns *namespace.Namespace, cmt *discussion.Comment) (string, error) {
...
func (_e *DiscussionRepository_Expecter) CreateComment(ctx interface{}, ns interface{}, cmt interface{}) *DiscussionRepository_CreateComment_Call {
	return &DiscussionRepository_CreateComment_Call{Call: _e.mock.On("CreateComment", ctx, ns, cmt)}
}

func (_c *DiscussionRepository_CreateComment_Call) Run(run func(ctx context.Context, ns *namespace.Namespace, cmt *discussion.Comment)) *DiscussionRepository_CreateComment_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DiscussionRepository_CreateComment_Call) RunAndReturn(run func(context.Context, *namespace.Namespace, *discussion.Comment) (string, error)) *DiscussionRepository_CreateComment_Call {
	_c.Call.Return(run)
	return _c
}

...
// Create provides a mock function with given fields: ctx, ns, template
func (_m *TagTemplateRepository) Create(ctx context.Context, ns *namespace.Namespace, template *tag.Template) error {
...
func (_e *TagTemplateRepository_Expecter) Create(ctx interface{}, ns interface{}, template interface{}) *TagTemplateRepository_Create_Call {
	return &TagTemplateRepository_Create_Call{Call: _e.mock.On("Create", ctx, ns, template)}
}

func (_c *TagTemplateRepository_Create_Call) Run(run func(ctx context.Context, ns *namespace.Namespace, template *tag.Template)) *TagTemplateRepository_Create_Call {
...
func (_c *TagTemplateRepository_Create_Call) RunAndReturn(run func(context.Context, *namespace.Namespace, *tag.Template) error) *TagTemplateRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
// Update provides a mock function with given fields: ctx, ns, templateURN, template
func (_m *TagTemplateRepository) Update(ctx context.Context, ns *namespace.Namespace, templateURN string, template *tag.Template) error {
...
//   - templateURN string
//   - template *tag.Template
func (_e *TagTemplateRepository_Expecter) Update(ctx interface{}, ns interface{}, templateURN interface{}, template interface{}) *TagTemplateRepository_Update_Call {
	return &TagTemplateRepository_Update_Call{Call: _e.mock.On("Update", ctx, ns, templateURN, template)}
}

func (_c *TagTemplateRepository_Update_Call) Run(run func(ctx context.Context, ns *namespace.Namespace, templateURN string, template *tag.Template)) *TagTemplateRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *TagTemplateRepository_Update_Call) RunAndReturn(run func(context.Context, *namespace.Namespace, string, *tag.Template) error) *TagTemplateRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}

...
func (lp lineageProcessor) LineageOf(record models.RecordV2) (upstream, downstream set.StringSet, err error) {
...
func (lp lineageProcessor) executeQuery(record models.RecordV2, query string) (values []string, err error) {

...
type Builder interface {
	Build(context.Context, discovery.TypeRepository, discovery.RecordRepositoryFactory) (Graph, error)
}
...
func (builder defaultBuilder) Build(ctx context.Context, tr discovery.TypeRepository, rrf discovery.RecordRepositoryFactory) (Graph, error) {
...
func (builder defaultBuilder) addRecord(graph AdjacencyMap, typeName string, ast asset.Asset) {
	entry := AdjacencyEntry{
		Type:        typeName,
		URN:         ast.URN,
		Service:     ast.Service,
		Downstreams: builder.buildAdjacents(ast, dataflowDirDownstream),
		Upstreams:   builder.buildAdjacents(ast, dataflowDirUpstream),
	}
...
func (builder defaultBuilder) buildAdjacents(r asset.Asset, dir dataflowDir) (adjacents set.StringSet) {
